	...
	<div class="row">
		...
		<div class="col-xs-3 col-sm-2">
			...
			<div id="market-menu" class="text-center">
				<a class="btn btn-sm wide-button" role="button" href="<?php echo base_url('/market') ?>"><b>all</b></a><br><br>
				<?php foreach ($categories->result() as $category) { ?>
				    <a class="btn btn-sm wide-button" role="button" href="<?php echo base_url('/market/category/' . $category->category_id); ?>"><b><?php echo $category->name; ?></b></a><br>
