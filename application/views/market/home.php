			...
			<div class="row">
				<div class="row text-center">
					<div class="btn-group hidden-xs">
						...
						<a class="btn btn-default" href="<?php echo base_url('/market/new_subcategory') ?>">Create a Subcategory</a>
						<?php } ?>
					</div>
					<div class="visible-xs">
						...
						<a class="btn btn-default" href="<?php echo base_url('/market/new_subcategory') ?>">Create a Subcategory</a><br>
						<?php } ?>
					</div>
				</div>
