		...
		<div class="col-xs-3 col-sm-2">
			...
			<div id="market-menu" class="text-center">
				...
				<?php foreach ($categories->result() as $cat) { ?>
				    <a class="btn <?php if ($subcategory->category_id == $cat->category_id) { echo 'btn-primary'; } else { echo 'btn-default'; } ?> btn-sm wide-button" role="button" href="<?php echo base_url('/market/category/' . $cat->category_id); ?>"><b><?php echo $cat->name; ?></b></a><br>
